...
-- 插入默认用户数据
INSERT INTO user (username, password, email, phone, role, is_enabled)
VALUES
...
-- 插入默认学习进度数据
INSERT INTO learning_progress (user_id, topic, progress_percentage, last_accessed, is_completed)
VALUES
(1, '元素周期表', 100.00, CURRENT_TIMESTAMP, TRUE),
(1, '化学反应', 75.00, CURRENT_TIMESTAMP, FALSE),
(2, '元素周期表', 50.00, CURRENT_TIMESTAMP, FALSE),
(2, '化学键', 30.00, CURRENT_TIMESTAMP, FALSE);
